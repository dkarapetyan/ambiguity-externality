...
class Player(BasePlayer):
    ...
    externality = models.IntegerField(
        ...
        choices=[[1,
                  "I would like to earn £0.10 for every 2 tokens, with 1 token taken away from the yellow player I am matched with."],
                 [2,
                  "I would like to earn £0.08 for every 2 tokens, with no tokens taken away from the yellow player I am matched with."]],
    )
